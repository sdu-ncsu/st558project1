...
### I would have a better plan for what data to use and what kinds of graphs and tables to make with the data.

### what was the most difficult part of the logic and programming for you?

### Remembering the different kinds of R data tyopes and various graphing options was challening.

### what are your big take-aways for future projects?

### My main takeaway is to look at the data a bit more before trying to figure out what to do with it in order to create more meaning representations.
